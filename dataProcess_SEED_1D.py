...
np.save("/home/kaka/Desktop/sfy_file/eeg_emotion/nonCrossSubject/data/SEED/DE0.5s/X_1D.npy", X)
np.save("/home/kaka/Desktop/sfy_file/eeg_emotion/nonCrossSubject/data/SEED/DE0.5s/y.npy", y)




X = np.load('/home/kaka/Desktop/sfy_file/eeg_emotion/nonCrossSubject/data/SEED/DE0.5s/X_1D.npy')
y = np.load('/home/kaka/Desktop/sfy_file/eeg_emotion/nonCrossSubject/data/SEED/DE0.5s/y.npy')
# 生成8*9的矩阵形式
...
X89[:, 6, 1:8, :] = X[:, 50:57, :]
X89[:, 7, 2:7, :] = X[:, 57:62, :]
np.save("/home/kaka/Desktop/sfy_file/eeg_emotion/nonCrossSubject/data/SEED/DE0.5s/X89.npy", X89)
