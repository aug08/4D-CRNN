...
falx = np.load('/home/kaka/Desktop/sfy_file/eeg_emotion/nonCrossSubject/data/SEED/DE0.5s/t4x_89.npy')
y = np.load('/home/kaka/Desktop/sfy_file/eeg_emotion/nonCrossSubject/data/SEED/DE0.5s/t4y_89.npy')
...
for nb in range(15):
    ...
    for train, test in kfold.split(one_falx, one_y.argmax(1)):
        ...
        model = Model([input_1, input_2, input_3, input_4], out_layer)
        # model.summary()
